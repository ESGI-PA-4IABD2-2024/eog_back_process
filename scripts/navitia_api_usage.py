...
from scripts.db.mysql_requests import insert_route_into_db, get_max_id_circulation, get_existing_stations_and_platforms, \
    insert_new_stations, insert_new_platforms, insert_new_circulations, insert_new_routes
...
def fetch_and_insert(ligne: str, DEBUG: bool = False):
    ...
    for circulation in dic_circulations:
        ...
        stations_values, platforms_values, routes_values, circulation_values, next_sql_id_for_station, next_sql_id_for_platform = prepare_insert_query(
