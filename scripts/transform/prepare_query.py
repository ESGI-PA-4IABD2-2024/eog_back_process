    ...
    while True:
        ...
        if platforms_of_departure_station.empty:
            if departure_station_name not in stations_waiting_to_be_inserted:
                ...
                stations_values.append(
                    (int(sql_id_departure_station), departure_station_name)
                )  # Conversion en int
                next_sql_id_for_station += 1
            else:
                sql_id_departure_station = stations_waiting_to_be_inserted[departure_station_name]
        else:
            sql_id_departure_station = int(
                platforms_of_departure_station.iloc[0]["ID_GARE"]
            )  # Conversion en int
        ...
        if platforms_of_arrival_station.empty:
            if arrival_station_name not in stations_waiting_to_be_inserted:
                ...
                stations_values.append(
                    (int(sql_id_arrival_station), arrival_station_name)
                )  # Conversion en int
                next_sql_id_for_station += 1
            else:
                sql_id_arrival_station = stations_waiting_to_be_inserted[arrival_station_name]
        else:
            sql_id_arrival_station = int(
                platforms_of_arrival_station.iloc[0]["ID_GARE"]
            )  # Conversion en int
        ...
        platform_of_arrival = platforms_of_arrival_station[
            platforms_of_arrival_station["LIGNE_PLATFORM"] == ligne
        ]
        ...
        if platform_of_departure.empty:
            ...
            if key not in plateform_waiting_to_be_inserted:
                ...
                platforms_values.append(
                    (
                        int(sql_id_departure_platform),
                        int(sql_id_departure_station),
                        ligne,
                        circulation.circulation_type,
                    )
                )  # Conversion en int
            ...
            sql_id_departure_platform = int(
                platform_of_departure.iloc[0]["ID_PLATFORM"]
            )  # Conversion en int
        ...
        if platform_of_arrival.empty:
            ...
            if key not in plateform_waiting_to_be_inserted:
                ...
                platforms_values.append(
                    (
                        int(sql_id_arrival_platform),
                        int(sql_id_arrival_station),
                        ligne,
                        circulation.circulation_type,
                    )
                )  # Conversion en int
            ...
            sql_id_arrival_platform = int(
                platform_of_arrival.iloc[0]["ID_PLATFORM"]
            )  # Conversion en int
